...
public abstract class UserStoreBaseISelect<TUser, TKey, TUserClaim, TUserLogin, TUserToken> :
    ...
    where TUserToken : IdentityUserToken<TKey>, new()
{
    ...
    /// </summary>
    public abstract ISelect<TUser> Users
    {
        get;
    }
...
public abstract class UserStoreBaseISelect<TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TUserToken, TRoleClaim> :
