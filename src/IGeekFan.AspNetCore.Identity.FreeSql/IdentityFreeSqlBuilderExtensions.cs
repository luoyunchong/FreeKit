...
/// </summary>
public static class IdentityFreeSqlBuilderExtensions
{
    /// <summary>
    ...
    public static IdentityBuilder AddFreeSqlStores<TContext>(this IdentityBuilder builder)
    ...
    private static void AddStores(IServiceCollection services, Type userType, Type roleType, Type contextType)
    {
        ...
        {
            throw new InvalidOperationException(CoreStrings.NotIdentityUser);
        }
        ...
        if (roleType != null)
        {
            ...
            {
                throw new InvalidOperationException(CoreStrings.NotIdentityRole);
            }
