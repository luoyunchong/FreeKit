...
public class UserOnlyStore<TUser, TContext, TKey, TUserClaim, TUserLogin, TUserToken> :
    UserStoreBaseISelect<TUser, TKey, TUserClaim, TUserLogin, TUserToken>,
    ...
    where TUserToken : IdentityUserToken<TKey>, new()
{
    ...
    public override async Task ReplaceClaimAsync(TUser user, Claim claim, Claim newClaim, CancellationToken cancellationToken = default)
    {
        ...
        var matchedClaims = await UserClaims
            ...
            .ToListAsync(false, cancellationToken);
    ...
    public override async Task<IList<TUser>> GetUsersForClaimAsync(Claim claim, CancellationToken cancellationToken = default)
    {
        ...
        var query = Users.InnerJoin<TUserClaim>((user, userclaims) => userclaims.UserId.Equals(user.Id) && userclaims.ClaimValue == claim.Value && userclaims.ClaimType == claim.Type);
