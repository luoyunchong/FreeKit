    ...
    where TKey : IEquatable<TKey>
{
    ...
    public async Task CanRoleFindById()
    {
        ...
        IdentityResultAssert.IsSuccess(await manager.CreateAsync(role));
        MyAssert.Equal(role, await manager.FindByIdAsync(await manager.GetRoleIdAsync(role)));
    }
    ...
    public async Task CanRoleFindByName()
    {
        ...
        Assert.False(await manager.RoleExistsAsync(roleName));
        IdentityResultAssert.IsSuccess(await manager.CreateAsync(role));
        MyAssert.Equal(role, await manager.FindByNameAsync(roleName));
    }
    ...
    public async Task CanUpdateRoleName()
    {
        ...
        MyAssert.Equal(role, await manager.FindByNameAsync("Changed"));
    }
